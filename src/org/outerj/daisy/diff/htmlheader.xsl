<?xml version="1.0"?>
<!-- Copyright 2004 Guy Van den Broeck Licensed under the Apache License, 
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
		...
		<html>
			...
			<body>
				...
				<xsl:variable name="spans"
					select="diffreport/diff//span[(@class='diff-html-added' or @class='diff-html-removed' or @class='diff-html-changed')  and @id]" />
                ...
                <xsl:value-of select="$spans[1]/@id" />
									...
									<img class="diff-icon" src="images/previous.png" title="Go to first change." />
								</a>
								<a>
									<xsl:attribute name="class">diffpage-html-a</xsl:attribute>
									<xsl:attribute name="onclick">scrollToEvent(event)</xsl:attribute>
                ...
                <xsl:value-of select="$spans[1]/@id" />
							...
							<td style="text-align: center; font-size: 140%;">
								<a style="font-size: 100%;" class="diffpage-html-a" href="http://www.cordelta.com/">
									<img class="h1" src="images/Cordelta.png" title="Cordelta website" />
								</a>
								<br />
                ...
                <xsl:value-of select="$spans[last()]/@id" />
									...
									<img class="diff-icon" src="images/next.png" title="Go to last change." />
								</a>
							</td>
						</tr>
					</table>
	...
	<xsl:template match="img">
		<img>
			<xsl:copy-of select="@*" />
			<xsl:if
				test="@changeType='diff-removed-image' or @changeType='diff-added-image'">
