...
public class Main {
  static boolean quietMode = false;
    ...
    public static void main(String[] args) throws URISyntaxException {
        ...
        {
            //help();
        	oldHTML = new String("http://localhost/1.html");
        	newHTML = new String("http://localhost/2.html");
        }
        else
        {
        	oldHTML = args[0];
        ...
        String outputFile = "defaultdiff.htm";
        ...
        try {
            ...
            if (!quietMode){
              ...
              System.out.println("           / HTML Comparor \\");
              System.out.println("          /_________________\\");
              System.out.println();
              System.out.println(" -= base on http://code.google.com/p/daisydiff/ =-");
              System.out.println("");
              System.out.println();
            ...
            if (oldHTML.startsWith("http://")) {
                oldStream = new URI(oldHTML).toURL().openStream();
            }
            else {
                oldStream = new FileInputStream(oldHTML);
            }
            if (newHTML.startsWith("http://")) {
                newStream = new URI(newHTML).toURL().openStream();
            }
            else {
                newStream = new FileInputStream(newHTML);
            }
